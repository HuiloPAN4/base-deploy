...
`cast send 0x036CbD53842c5426634e7929541eC2318f3dCF7e "approve(address,uint256)" $COUNTER_CONTRACT_ADDRESS 10000000 --rpc-url $BASE_SEPOLIA_RPC_URL --account deployer`

## Notes

- Network: Base Sepolia (chain id 84532).
- Minting charges 10 USDC on Base Sepolia (0x036CbD53842c5426634e7929541eC2318f3dCF7e).
